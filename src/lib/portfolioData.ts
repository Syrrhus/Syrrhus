export const portfolioContent = {
    introduction: {
        displayName: "SEAN HO\nJUNXIAN",
        subtitle: "Developer. Designer. Budding artist",
    ...
    experiences: [
        {
            company: "Finsurge",
            role: "AI Fraud Detection Platform Developer",
            duration: "Aug 2025 – present",
            image: "/STlogo.png",
            description: "Front-end developer on a Unified Platform consolidating multiple FinSurge AI products. \
            Developed ML models for fraud detection and \
            conducted user research with Standard Chartered and other financial institutions, \
            Supported Trade Surveillance, Anti-Money Laundering (AML), and Loan Origination products."
        },
        {
    ...
    gallery: [
        {
            image: "/sunflower.PNG",
            text: "Sunflower",
            description: "Original artpiece of the Scadutree Avatar character from Elden Ring."
        },
        {
            image: "/sttrina.PNG",
            text: "St Trina Portrait",
            description: "Artpiece of St Trina from Elden Ring."
        },
        {
            image: "/IMG_0489.PNG",
            text: "Rafael Nadal",
            description: "A portrait of Rafael Nadal."
        },
        {
            images: ["/pixelart1.PNG", "/pixelart2.PNG", "/pixelart3.PNG"],
            text: "Pixel Art for Shady Sweatshop Game",
            description: "A series of pixel art pieces created for my game project, Shady Sweatshop"
        },
        {
            image: "/Cloud-upscaled.png",
            text: "Cloud Study",
            description: "A study of cloud formations I observed. I was fascinated by the the various shapes of the clouds\
            and the way light interacts with them."
        },
        {
            image: "/IMG_0485.PNG",
            text: "IU portrait",
            description: "A portrait of IU, done together with a friend"
        }
    ...
    quickLinks: [
        {
            name: "LinkedIn",
            url: "https://www.linkedin.com/in/seanhojunxian/"
        },
        {
            name: "X",
            url: "https://www.linkedin.com/in/seanhojunxian/"  // placeholder
        },
        {
            name: "Email",
            url: "mailto:seanhojunxian@gmail.com"
        }
    ]
};